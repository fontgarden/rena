...
def draw_main_text():
    ...
    db.fontSize(512 + 32)
    db.fontSize(530)
    db.text("Free Software", (MARGIN - 8, MARGIN * 13.0))
    db.text("and the", (MARGIN - 8, MARGIN * 11.0))
    db.text("International", (MARGIN - 8, MARGIN * 9.0))
    db.text("Typographic", (MARGIN - 8, MARGIN * 7.0))
    db.text("Style", (MARGIN - 8, MARGIN * 5.0))
    db.text("", (MARGIN - 8, MARGIN * 3.0))
