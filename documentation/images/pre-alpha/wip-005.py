...
#db.rect(0,0,W,U*5+1)
db.fill(0.9)
db.text("₿itcoin & the", (M+(U*0), M+(U*14)), align="left")
db.text("Bahá’í Faith", (M+(U*4.25), M+(U*12)), align="left")
#db.text("Bahá’í Faith", (M+(U*0), M+(U*12)), align="left")
#db.text("Eli Heuer", (M+(U*0), M+(U*2)), align="left")

db.fill(0.9, 0.3, 0.0)
db.oval(M+(U*6), U*6, U*4, U*4)
#db.oval(M+(U*1), U*1, U*4, U*4)
#db.oval(M+(U*12), U*1, U*4, U*4)
