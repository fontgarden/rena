...
TOP_ROW = 24
#db.text("“I think true modernists ", (M+(U*(0.65)), M+(U*(TOP_ROW-0))), align="left")
#db.text("wanted open-source design", (M+(U*(-0.175)), M+(U*(TOP_ROW-2))), align="left")
#db.text("one hundred years ago,", (M+(U*(-0.175)), M+(U*(TOP_ROW-4))), align="left")
#db.text("but back then it wasn’t possible.", (M+(U*(-0.175)), M+(U*(TOP_ROW-6))), align="left")
...
db.fontSize(SIZE)
db.lineHeight(SIZE*1)
db.fill(0.75)
LONG_TEXT_001 = "“I think true modernists wanted open-source design one hundred years ago, but back then it wasn’t possible. One of modernism’s core flaws was the huge amount of power that ended up in the hands of a few big firms. The movment was supposed to be about the democratization of design—that was their big idea—but somewhere along the line it became nothing more than an aesthetic.”"
db.textBox(LONG_TEXT_001,(M+(U*0),M+(U*0), U*32, U*32), align="left")
db.text(f"Rena Bold Pre-Alpha: Optical Size {OPSZ}", (M+(U*(0)), M+(U*(0))), align="left")
