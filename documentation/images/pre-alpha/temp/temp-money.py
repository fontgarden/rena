...
LONG_TEXT_001 = "“Money is one of the oldest technologies that humanity has. It precedes writing. How do we know that? The very first samples of writing we have are spreadsheets. Tallies and ledgers of debts owed, and money pre-existed that writing. You might even speculate thatmoney had an oral tradition until it needed to invent a written tradition, and so writing was created for it. Money is a language, a linguistic abstraction. We use money to expressand create social bonds, relationships, associations, and organisations. Bitcoin is a system of money that is not controlled by any single entity, that is completly decentralized. And what that does is it introduces the very same things that the internet brought to communication. If money is speech, if money is a language, and you disonnect it from all other media, and you make it pure speech, pure content, an internet content type, a proocol designation, money over IP. It completly separates it from all previous notons of nations, sovereign issuers, institutions that control. We go from institution-based money to network-based money, and of course, veryone will welcome this with open arms... Not a chance.” \n\n—Andreas Antonopoulos"
db.textBox(LONG_TEXT_001,(M+(U*0),M-(U*3), U*30, U*32), align="left")


db.fontVariations(wght=700)
db.fontVariations(opsz=OPSZ)
db.text("Rena Regular 144", (M+(U*(0)), M+(U*(31))), align="left")
TOP_ROW = 15
